...
<head>
    ...
    <style>
        ...
        main {
            max-width: 800px; /* Same width as other pages for consistency */
            margin: 2rem auto;
            padding: 0 1rem;
        }
        .booking-details {
...
<body>
    ...
    <main>
        ...
        <div class="booking-details">
            ...
            <?php $pricePerPerson = 12999; ?>
            <div class="price">₱<?php echo number_format($pricePerPerson, 2);?> per couple</div>
            <div class="duration">4 Days, 3 Nights</div>
            <p class="description">
                Celebrate love with our specially curated romantic getaways. Enjoy intimate moments, luxurious accommodations, and unforgettable experiences designed just for couples.
            </p>
        ...
        <form class="booking-form" action="romance_booking.php?destination=<?php echo urlencode($destination); ?>" method="POST">
            ...
            <p>Please fill in the details to confirm your romantic booking.</p>
