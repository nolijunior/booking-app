...
<head>
    ...
    <style>
        ...
        body::before {
            ...
            position: fixed;
            inset: 0;
            background: rgba(255, 255, 255, 0.5); /* Match the light overlay from the payment page */
            z-index: -1;
        }
        header {
            padding: 1.5rem 3rem;
        ...
        main {
            max-width: 800px; /* Same width as adventure_booking.php for consistency */
            margin: 2rem auto;
            padding: 0 1rem;
        }
        .booking-details {
            background: #fff;
            padding: 2.5rem;
            border-radius: 0.8rem; /* Slightly reduced for rectangular look */
        ...
        .form-submit {
            background: #f28c38; /* Orange color from payment page */
            color: #fff;
        }
        .form-submit:hover {
            background: #e67e22;
...
<body>
    ...
    <main>
        ...
        <div class="booking-details">
            ...
            <p class="description">
                Elevate your next corporate outing, team-building event, or group getaway with our Corporate & Group Travel package. Enjoy seamless planning, spacious accommodations, and curated group activities designed to foster teamwork and relaxation.
            </p>
        ...
        <form class="booking-form" action="corporate_booking.php?destination=<?php echo urlencode($destination); ?>" method="POST">
            <h3>Book Your Corporate Trip</h3>
            <p>Please fill in the details to confirm your group booking.</p>
