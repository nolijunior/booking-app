    ...
    <main>
        ...
        <div class="destinations-grid">
            ...
            <article class="destination-card">
                <img src="destinations/makati.jpg" alt="Makati" class="destination-img">
            ...
            <article class="destination-card">
                <img src="destinations/bgc.jpg" alt="Bonifacio Global City" class="destination-img">
                <div class="destination-content">
            ...
            <!-- 3. Clark -->
            <article class="destination-card">
                <img src="destinations/clark.jpg" alt="Clark" class="destination-img">
                <div class="destination-content">
            ...
            <!-- 4. Cebu City -->
            <article class="destination-card">
                <img src="destinations/cebu_city.jpg" alt="Cebu City" class="destination-img">
                <div class="destination-content">
            ...
            <!-- 5. Davao City -->
            <article class="destination-card">
                <img src="destinations/davao.jpg" alt="Davao City" class="destination-img">
                <div class="destination-content">
            ...
            <!-- 6. Subic -->
            <article class="destination-card">
                <img src="destinations/subic.jpg" alt="Subic" class="destination-img">
                <div class="destination-content">
