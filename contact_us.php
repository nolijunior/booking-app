...
/* Existing styles remain, add these below header styles */
header {
    padding: 1.5rem 3rem;
    display: flex;
...
<section class="faq" aria-labelledby="faq-title">
    ...
    <dl>
        ...
        <dd>As of now, We only accept bank transfers through selected credit/debit cards. But we assure everyone that once this website is fully established including the payment section, we will include Gcash, PayMaya, and other online payment transactions, we will include that in our payment method. Details will be provided once your booking is confirmed.</dd>
