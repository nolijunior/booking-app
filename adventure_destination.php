        ...
        <div class="destinations-grid">
            <article class="destination-card">
                ...
                <div class="destination-content">
                    ...
                    <p class="destination-desc">Famous for its surfing spots, rock pools, and island hopping.</p>
            ...
            <article class="destination-card">
                ...
                <div class="destination-content">
                    ...
                    <p class="destination-desc">Known for its breathtaking "sea of clouds" and challenging trails.</p>
            ...
            <article class="destination-card">
                ...
                <div class="destination-content">
                    ...
                    <p class="destination-desc">Limestone cliffs, hidden lagoons, and island tours await you.</p>
            ...
            <article class="destination-card">
                ...
                <div class="destination-content">
                    ...
                    <p class="destination-desc">A UNESCO World Heritage Site with stunning ancient rice terraces.</p>
            ...
            <article class="destination-card">
                ...
                <div class="destination-content">
                    ...
                    <p class="destination-desc">Whitewater rafting and adventure sports in the City of Golden Friendship.</p>
            ...
            <article class="destination-card">
                ...
                <div class="destination-content">
                    ...
                    <p class="destination-desc">Caves, waterfalls, and hanging coffins for cultural explorers.</p>
            ...
            <article class="destination-card">
                ...
                <div class="destination-content">
                    ...
                    <p class="destination-desc">Swim with whale sharks in their natural habitat.</p>
            ...
            <article class="destination-card">
                ...
                <div class="destination-content">
                    ...
                    <p class="destination-desc">The highest mountain in the Philippines with diverse ecosystems.</p>
