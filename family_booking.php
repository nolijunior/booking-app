...
<body>
    ...
    <main>
        ...
        <div class="booking-details">
            ...
            <p class="description">
                Create unforgettable memories with your family. Enjoy quality time together with fun activities, relaxing accommodations, and kid-friendly adventures.
            </p>
        ...
        <form class="booking-form" action="family_booking.php?destination=<?php echo urlencode($destination); ?>" method="POST">
            <h3>Book Your Family Vacation</h3>
            <p>Please fill in the details to confirm your family booking.</p>
