...
<body>
    ...
    <main>
        ...
        <div class="booking-details">
            ...
            <p class="description">
                Immerse yourself in rich traditions and fascinating history with our Cultural & Historical Journeys package. Explore ancient sites, local museums, and experience authentic cultural performances.
            </p>
        ...
        <form class="booking-form" action="cultural_booking.php?destination=<?php echo urlencode($destination); ?>" method="POST">
            <h3>Book Your Cultural Journey</h3>
